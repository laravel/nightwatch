...
{
    public function test_it_limits_the_length_of_the_user_identifier()
    {
    ...
    public function test_it_can_lazily_retrieve_the_user()
    {
        $provider = new UserProvider($this->app['auth'], fn () => []);
    ...
    public function test_it_can_remember_an_authenticated_user_and_limits_the_length_of_their_identifier()
    {
        $provider = new UserProvider($this->app['auth'], fn () => []);
