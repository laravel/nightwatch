...
/** @var array{listenOn: string, viaPhar: bool, ingestDetailsBrowser: \Tests\BrowserFake|null, ingestBrowser: \Tests\BrowserFake|null, loop: \Tests\LoopFake|null, server: \Tests\TcpServerFake|null, silent: bool|null, quiet: bool|null, verbose: bool|null, maxBufferLength?: int }  $payload */
[
    'listenOn' => $listenOn,
    'viaPhar' => $viaPhar,
