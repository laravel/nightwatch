...
final class Request
{
    ...
    public function __construct(
        ...
        // $this->port = Number::uInt32($this->port);
        ...
        // $this->route_methods = array_map(Str::tinyText(...), array_slice($this->route_methods, 0, 10));
        ...
        // $this->ip = Str::restrict($this->ip, 45);
        // $this->duration = // !!! Number::uInt64($this->duration);
        // $this->status_code = // Number::uInt($this->status_code, 599);
        // $this->request_size = // !! Number::uInt64($this->request_size);
    }
}
