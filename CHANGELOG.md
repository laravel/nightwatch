...
## [Unreleased](https://github.com/laravel/nightwatch/compare/v1.30.2...1.x)
...
## [v1.30.2](https://github.com/laravel/nightwatch/compare/v1.30.1...v1.30.2) - 2026-09-18

### What's Changed

* Refresh expired token before ingesting by [@avosalmon](https://github.com/avosalmon) in https://github.com/laravel/nightwatch/pull/428

**Full Changelog**: https://github.com/laravel/nightwatch/compare/v1.30.1...v1.30.2

## [v1.30.1](https://github.com/laravel/nightwatch/compare/v1.30.0...v1.30.1) - 2026-09-16

### What's Changed

* Bump the github-actions group with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/421
* Bump the composer group in /agent with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/424
* Bump phpstan/phpstan from 2.2.9 to 2.2.12 in /agent in the composer group by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/425
* Bump softprops/action-gh-release from 3.0.2 to 3.0.3 in the github-actions group by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/426
* Bump the composer group in /agent with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/427

**Full Changelog**: https://github.com/laravel/nightwatch/compare/v1.30.0...v1.30.1
...
* Bump EndBug/add-and-commit from 10.0.0 to 11.0.0 in the github-actions group by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/417
* Allow limiting events ingested per app / env based on an event listener by [@timacdonald](https://github.com/timacdonald) in https://github.com/laravel/nightwatch/pull/418
* Support Guzzle 3.0 by [@timacdonald](https://github.com/timacdonald) in https://github.com/laravel/nightwatch/pull/420

**Full Changelog**: https://github.com/laravel/nightwatch/compare/v1.28.7...v1.29.0

## [v1.28.7](https://github.com/laravel/nightwatch/compare/v1.28.6...v1.28.7) - 2026-08-13

### What's Changed

* Bump the composer group in /agent with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/411
* Ingest unhandled exception immediately while sampling by [@timacdonald](https://github.com/timacdonald) in https://github.com/laravel/nightwatch/pull/414
* Deeply unwrap view exceptions by [@timacdonald](https://github.com/timacdonald) in https://github.com/laravel/nightwatch/pull/415

**Full Changelog**: https://github.com/laravel/nightwatch/compare/v1.28.6...v1.28.7

## [v1.28.6](https://github.com/laravel/nightwatch/compare/v1.28.5...v1.28.6) - 2026-08-07

### What's Changed

* Bump the github-actions group with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/405
* Bump docker/login-action from 4.5.0 to 4.6.0 in the github-actions group by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/408
* Bump the composer group in /agent with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/nightwatch/pull/407
* Improved JSON encoding by [@timacdonald](https://github.com/timacdonald) in https://github.com/laravel/nightwatch/pull/410

**Full Changelog**: https://github.com/laravel/nightwatch/compare/v1.28.5...v1.28.6
